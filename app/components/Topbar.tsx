...
import { clearAuthSession, initials, useAuth, useCompanies, usePlan } from '@/app/lib/data'
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          <span style={{ width: 7, height: 7, borderRadius: 2, background: activeCompany?.accentColor || colors.blue, flexShrink: 0 }} />
          <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {activeCompany?.name || '+ Bedrijfsprofiel instellen'}
          </span>
